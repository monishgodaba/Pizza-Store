...
const Footer = () => {
  return (
    <footer className=" bg-black text-white rounded-t-3xl mt-8 md:mt-0">
      <div className="flex flex-col md:flex-row justify-between p-8 md:px-32 px-5 mt-5">
        <div className=" w-full md:w-1/4">
          <h1 className=" font-semibold text-xl pb-4">CheesyBites</h1>
          <p className=" text-sm">
          The company itself is a very successful company. Do they fall and suffer?
          </p>
        </div>
        <div>
      ...
      <div>
        <p className=" text-center py-4">
          ...
          <span className=" text-yellow-500"> Cheesy Delight</span> | All
          rights reserved
        </p>
      </div>
    </footer>
